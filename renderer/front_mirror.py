...
#hdr_path =  hdri
#save_path = "./data/render_results/" + hdri+ "/mirror/"

hdr_path =  hdri
save_path = save + "/mirror/"
...
# else:
#     for d in hdr_img[start: ]:
#         hdri_path = hdr_path + "/" + d
#         utils.build_environment_texture_background(world, hdri_path)
#         scene.render.filepath = save_path + d
#         bpy.ops.render.render(write_still=True)
# # hdri_path = "/home/ynyang/Downloads/blender-cli-rendering-master/black.exr"
# # utils.build_environment_texture_background(world, hdri_path)
# # scene.render.filepath = save_path+"black.exr"
# # bpy.ops.render.render(write_still=True)